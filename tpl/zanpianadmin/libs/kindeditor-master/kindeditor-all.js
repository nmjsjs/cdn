...
_extend(KCmd, {
	...
	insertimage : function(url, title, width, height, border, align) {
		...
		var html = '<img src="' + _escape(file) + '" data-ke-src="' + _escape(url) + '" ';
		if (width) {
...
_plugin('core', function(K) {
	...
	self.beforeSetHtml(function(html) {
		...
		.replace(/(<[^>]*)(href|src)="([^"]*)"([^>]*>)/ig, function(full, start, key, src, end) {
			...
			if(src.substr(0,8)=='zanpian:'){
			    var file = src.replace('zanpian:', '');
		    }
			full = start + key + '="' + file + '"' + ' data-ke-src="' + _escape(src) + '"' + end;
			return full;
		})
